...
public class Session1 {
	...
	public static void main(String[] args) throws IOException, InterruptedException  {
		...
		AndroidDriver driver= new AndroidDriver<MobileElement>(new URL("http://127.0.0.1:4723/wd/hub"),cap);
	   ...
	   // driver.findElementByAndroidUIAutomator("new UIselector().text(”\Preference\”));
	    ...
	    TouchAction ta= new TouchAction(driver);
	     List<RemoteWebElement> el = driver.findElementsByClassName("android.widget.TextView");
	     el.get(8).click();
	     //driver.zoom(el);
	     //driver.zoom(x, y);
	     //ta.tap(el);
